...
/*
	...
	A a=new A(); => a.aa
	A.bb (=> static 은 자동으로 메모리 저장됐기 때문에 new 필요 없다)
*/
public class MusicSystem {
	@Getter
	@Setter 
	private static Music[] musics=new Music[50]; // 값을 채운다 
	static // static 블록 (초기화 블록) => static은 static블록 써야한다
	{
//		 (초기화 블록)
//		 static 블록 => static 변수만 사용이 가능 => 자동 인식
//		 상속은 불가능 => 호출없이 실행이 가능
//		 생성자 를 이용할 수도 있다 (static 변수는 static 블록 사용이 편하다)
//		 1. 예외처리 => io(파일,메모리,네트워크 입출력) => 프로그램의 정상 종료 
//		    (=> 중간에 오류 발생해도 건너뛰고 끝까지 실행 후 종료)
