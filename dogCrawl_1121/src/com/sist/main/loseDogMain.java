...
//			System.out.println(detatitle); // detatitle 이 상세보기 title
			dvo2.setTitle(detatitle); // 상세 제목(title) VO
...
//			System.out.println(info); // info = 글 정보 
			dvo2.setInfo(info); // 상세 제목 아래 info VO
