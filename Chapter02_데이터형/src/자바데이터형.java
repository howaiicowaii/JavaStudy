 ...
 *            10.5(double) , 10.5F(f) = float
 *            ------------ 10.5d(D) = double은 생략가능
 ...
 *             long (8byte) ==> 가장 범위가 큼 => L((l) 입력해줘야 함
 *        -------------------------
