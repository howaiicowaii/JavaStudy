/*
	...
	=> **String / StringBuffer
	StringBuffer : 문자열 결합시 최적화 (속도 빠르다)
	------------ 임시 저장 장소 
	------------ append() => + 와 같은 류 = concat() / StringBuffer 나오면 나온다!
	String : 문자열 관리 
	------
	  equals() : 문자열이 같은지 확인 
	  length() : 문자 갯수 
...
public class MainClass_1 /*extends Object*/{
	...
	public static void main(String[] args) /*extends Object*/{
		// TODO Auto-generated method stub
		// toString() => 객체를 문자열화 
		// 생략이 가능 
