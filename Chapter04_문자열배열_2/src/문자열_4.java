...
//		System.out.println("max="+max);
		...
		System.out.println("==================================");
		// 노래명중에 가장 긴 제목의 노래와 가수명, 앨범명을 출력하시오
		int len = 0;
		for(String t:title)
		{
			if(len<t.length())
		...
		System.out.println("하강한 노래 갯수 : "+count);
		System.out.println("=====================================");
		// 임영웅의 노래 제목을 출력하시오
		count=0;
		for(i=0;i<title.length;i++)
		...
		System.out.println("======================================");
		// 검색어를 입력받아서 => 검색어가 포함되어 있는 노래명을 출력 
		System.out.print("검색어 입력 : ");
		String fd = sc.next();
		for(String f:title) // 타이틀만 갖고 왔으니 for-each / 가수명까지 가버리면 index
		{
			if(f.contains(fd))
			{
