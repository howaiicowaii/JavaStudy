...
class B extends A
{
	int a=100,b=200;
	int c,d;
	void aaa() // 오버라이딩(변경) => 상속받은 메소드를 변경 
	{
...
// B 클래스는 A 클래스에 있는 모든 것을 사용할 수 있다 ( a,b,aaa() )
// A 클래스는 B 클래스에 있는 모든 것을 샤용할 수 없다 ( a,b,aaa() ) 자신 것만 사용 가능 
public class MainClass2 {

	public static void main(String[] args) {
		// TODO Auto-generated method stub
		A a=new A(); // B 클래스에 있는 변수,메소드는 사용이 불가능하다
...
//		System.out.println("aa.c=>"+aa.c);
		...
		// 메소드 => new B() 생성자
//		aa.bbb(); 
		B bb=(B)aa; // 상위클래스 => 하위 클래스로 받는 경우 => 형변환 
//		---------- 가장 많이 등장하는 경우 
...
//		B cc=(B)new A(); // 오류 발생 
		/*
			상속 : 하위클래스로 접근하는 것이 기본 
			      ...
			      class B extends A 
			      B b=new B(); => 기본 코딩 
	  상속 제외조건  = static , private , 생성자 , 초기화 블록 
	  			 = 상위클래스는 공통적으로 사용하는 메소드 , 변수 
			      A => 여러개를 한개의 클래스로 제어할 때 
		*/
		...
		/*
		  ...
		  *** 단일 상속만 가능하다 
		  ...
		  상위 클래스는 하위 클래스가 가지고 있는 변수,메소드를 사용할 수 없다
