...
/*
	...
	--------------- => 주소를 이용해서 접근이 가능하다 (.)
	  ...
	  -------------
	---------------
	* 클래스는 여러 개의 데이터를 한개로 묶어서 메모리에 저장 후 사용
	         ------------ 클래스 설계
	                      --------
	                       => new를 이용해서 메모리에 저장 
	* 주소에 대한 개념이 거의 없다 
	...
	-----------------------------------------
      ...
      ** 클래스는 단순화 작업 => 시뮬레이션 
        ...
        *** 클래스는 일반(기본형) 동일하게 사용 
            ----   .   , 배열 (index)
             |
           형변환 => 상속(is-a)이 있거나, 포함(has-a)을 했을 때
...
public class MainClass2 {
	...
	public static void main(String[] args) {
		...
		// 변경 
		card1.width=250; // 변수가 1,2 따로 저장되어 1,2는 메모리 주소가 다르다 
		card1.height=300; 
		// => static 을 width, height 앞에 입력해주면 같은 공간에 저장 
//		             					          (= 공유변수)
//		card2.width=250;
//		card2.height=300;
		System.out.println("card1.type="+card1.type);
